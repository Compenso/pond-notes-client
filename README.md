...
Moving onto the elements:
As a user, I'll need to sign up with an email and password
As a user, I'll submit these with a button click
As a user, I'll want to be able to sign in.
As a user, I'll want to be able to change my password.
